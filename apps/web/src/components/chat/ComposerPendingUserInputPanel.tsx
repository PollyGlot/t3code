...
const ComposerPendingUserInputCard = memo(function ComposerPendingUserInputCard({
  ...
  return (
    <Collapsible open={!collapsed} onOpenChange={onToggleCollapsed} className="px-4 py-3 sm:px-5">
      <CollapsibleTrigger
        aria-label={collapsed ? "Expand question options" : "Collapse question options"}
        className="flex w-full items-center gap-3 text-left outline-none focus-visible:ring-1 focus-visible:ring-primary/25 rounded-md"
      >
        ...
        <ChevronDownIcon
          className={cn(
            "size-4 shrink-0 text-secondary-label transition-transform duration-200",
            collapsed && "-rotate-90",
          )}
        />
      </CollapsibleTrigger>
